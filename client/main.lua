...
local mainMenu = MenuV:CreateMenu(false, Lang:t('menu.admin_menu'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test1')
local adminOptions = MenuV:CreateMenu(false, Lang:t('menu.admin_options'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test2')
local playerOptions = MenuV:CreateMenu(false, Lang:t('menu.online_players'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test3')
local serverOptions = MenuV:CreateMenu(false, Lang:t('menu.manage_server'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test4')
local developerOptions = MenuV:CreateMenu(false, Lang:t('menu.developer_options'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test5')
...
OpenPlayerMenu = function(player)
  local playerMenu = MenuV:CreateMenu(false, player.id .. Lang:t('info.options'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test6')
...
OpenBanMenu = function(banplayer)
  local banMenu = MenuV:CreateMenu(false, Lang:t('menu.ban'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test9')
  banMenu:ClearItems()
...
OpenKickMenu = function(kickplayer)
  local kickMenu = MenuV:CreateMenu(false, Lang:t('menu.kick'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test7')
  kickMenu:ClearItems()
...
OpenPermsMenu = function(permsplayer)
  RSGCore.Functions.TriggerCallback('admin:server:hasperms', function(hasperms)
    if hasperms then
      local permMenu = MenuV:CreateMenu(false, Lang:t('menu.perms'), menuLocation, 220, 20, 60, menuSize, 'RSGCore', 'menuv', 'test8')
      permMenu:ClearItems()
